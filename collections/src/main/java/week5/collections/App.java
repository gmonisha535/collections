...
public class App{
    ...
    public static void main( String[] args ){	
    	...
    	clist1.add(new Integer(1));
    	clist1.add(new Integer(2));
    	clist1.add(new Integer(3));
    	clist1.add(new Integer(4));
    	clist1.add(new Integer(5));
    	clist1.add(new Integer(6));
    	clist1.add(new Integer(7));
    	clist1.add(new Integer(8));
    	clist1.add(new Integer(9));
    	clist1.add(new Integer(10));
